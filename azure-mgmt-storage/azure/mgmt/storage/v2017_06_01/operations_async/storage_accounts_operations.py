...
class StorageAccountsOperations(object):
    ...
    async def update(
        ...
        :type parameters:
         ~azure.mgmt.storage.v2017_06_01.models.StorageAccountUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.storage.v2017_06_01.models.StorageAccountPaged[~azure.mgmt.storage.v2017_06_01.models.StorageAccount]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_keys(
        ...
        :rtype:
         ~azure.mgmt.storage.v2017_06_01.models.StorageAccountListKeysResult or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
